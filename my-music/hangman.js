...
hangManGame.theGame = (function (window, $, namespace) {
   ...
   // This is to be called every time when a new game starts. do all setup for single game
    _setupSingleGame = function(){ 
        ...
        letterCounter = 0; // We rest the letter counter, when a game begins
...
hangManGame.gameConfig = (function (window, $, namespace) {
    ...
    var init,
        ...
        wordListType = ['Hollywood Movies','Countries Name','Characters - Mahabharatha','Characters - Game of Thrones'],  
        // add the word list here      
        wordList = ["To Kill a Mockingbird,Raiders of the Lost Ark,Casablanca,High Noon,The Silence of the Lambs,Rocky,Aliens,Lawrence of Arabia,The Grapes of Wrath,Star Wars,Norma Rae,Shane,Dirty Harry,The Adventures of Robin Hood,In the Heat of the Night,Butch Cassidy and the Sundance Kid,Gandhi,Spartacus,On the Waterfront,The Pride of the Yankees,Superman,Patton,Cool Hand Luke,Erin Brockovich,The Big Sleep,Fargo,Tarzan the Ape Man,Sergeant York,True Grit,Star Wars,City Lights,Lassie Come Home,Serpico,Goodbye,Boys Town,The Ten Commandments,The French Connection,The Mark of Zorro,Batman,Silkwood,Philadelphia,Gladiator,Psycho,Jaws,The Exorcist,North by Northwest,The Silence of the Lambs,Alien,The Birds,The French Connection,Raiders of the Lost Ark,The Godfather,King Kong,Bonnie and Clyde,Rear Window,Deliverance,Chinatown,The Manchurian Candidate,Vertigo,The Great Escape,High Noon,A Clockwork Orange,Taxi Driver,Lawrence of Arabia,Double Indemnity,Titanic,The Maltese Falcon,Star Wars,Fatal Attraction,The Shining,The Deer Hunter,Close Encounters of the Third Kind,Strangers on a Train,The Fugitive,The Night of the Hunter,Jurassic Park,Bullitt,Casablanca,Notorious,Die Hard,Dirty Harry,The Terminator,The Wizard of Oz,Saving Private Ryan,Carrie,Invasion of the Body Snatchers,Dial M for Murder,Marathon Man,Raging Bull,Rocky,Pulp Fiction,Butch Cassidy and the Sundance Kid,Wait Until Dark,Frankenstein,The Bridge on the River Kwai,Planet of the Apes,The Sixth Sense,Cape Fear,Spartacus,Touch of Evil,The Dirty Dozen,The Matrix,The Treasure of the Sierra Madre,Halloween,The Wild Bunch,Dog Day Afternoon,Goldfinger,Platoon,Laura,Blade Runner,The Third Man,Gaslight,The Magnificent Seven,Rebecca,The Omen,The Day the Earth Stood Still,The Phantom of the Opera,Poltergeist,Dracula,The Picture of Dorian Gray,The Thing from Another World,The Guns of Navarone,The Poseidon Adventure,Braveheart,Body Heat,Night of the Living Dead,The China Syndrome,Full Metal Jacket,Blue Velvet,Blood Simple,Speed,The Adventures of Robin Hood",
